  ...
  Effect.acquireRelease(
    Effect.gen(function* () {
      ...
      yield* sql`INSERT INTO ${foods}
        ...
        VALUES
        ('Example', 52, 14, 'branded', 1, '00000000000001', 'Apple', 100, 'g', 0.3, 30000, 'b-1', 0.2, NULL),
        ('Example', 237, 34, 'branded', 2, '00000000000002', 'Apple Pie', 100, 'g', 2.4, 30000, 'b-2', 11, NULL),
        (NULL, 57, 15, 'raw', 3, NULL, 'Raw Apple', 100, 'g', 0.3, 30000, 'r-1', 0.1, NULL),
        ('Broken', NULL, NULL, 'branded', 4, '00000000000004', 'Broken Food', 100, 'g', NULL, 2, 'bad-1', NULL, NULL),
        ('USDA', 90, 0.4, 'branded', 5, '00000000000005', 'Egg Fried', 100, 'g', 6.3, 1, 'usda-1', 6.8, NULL),
        ('OFF', 90, 0.4, 'branded', 6, '00000000000006', 'Egg Fried', 100, 'g', 6.3, 2, 'off-1', 6.8, NULL),
        (NULL, 295, NULL, 'raw', 7, NULL, 'Cardamom Seed', 100, 'g', 10.8, 9, 'au-1', 6.7, NULL),
        (NULL, 620, 48, 'restaurant', 8, NULL, 'Apple Burger', 1, 'serving', 31, 11, 'menu-1', 34, 1),
        (NULL, 25, 4, 'raw', 9, NULL, 'Ground Cardamom Leaves', 100, 'g', 2, 4, 'leaf-1', 0.2, NULL)`
