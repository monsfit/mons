    ...
    Effect.gen(function* () {
      ...
      yield* sql`INSERT INTO ${foods}
        (brand, calories, carbohydrates_total, dataset_kind, food_id, gtin,
         ...
         source_record_id, total_fat)
        VALUES
        ('Example', 52, 14, 'branded', 1, '00000000000001', 'Apple', 100, 'g', 0.3, 30000, 'b-1', 0.2),
        ('Example', 237, 34, 'branded', 2, '00000000000002', 'Apple Pie', 100, 'g', 2.4, 30000, 'b-2', 11),
        (NULL, 57, 15, 'raw', 3, NULL, 'Raw Apple', 100, 'g', 0.3, 30000, 'r-1', 0.1),
        ('Broken', NULL, NULL, 'branded', 4, '00000000000004', 'Broken Food', 100, 'g', NULL, 2, 'bad-1', NULL),
        ('USDA', 90, 0.4, 'branded', 5, '00000000000005', 'Egg Fried', 100, 'g', 6.3, 1, 'usda-1', 6.8),
        ('OFF', 90, 0.4, 'branded', 6, '00000000000006', 'Egg Fried', 100, 'g', 6.3, 2, 'off-1', 6.8),
        (NULL, 295, NULL, 'raw', 7, NULL, 'Cardamom Seed', 100, 'g', 10.8, 9, 'au-1', 6.7),
        ('Example Grill', 620, 48, 'restaurant', 8, NULL, 'Apple Burger', 1, 'serving', 31, 11, 'menu-1', 34)`
