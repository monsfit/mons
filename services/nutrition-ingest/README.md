...
```text
mons.foods                    partitioned parent
├── mons.raw_foods
└── mons.branded_foods

mons.portions                 partitioned parent
├── mons.raw_portions
└── mons.branded_portions

mons.nutrient_definitions     field units and descriptions
mons.ingestion_runs           snapshot provenance and load status
```
